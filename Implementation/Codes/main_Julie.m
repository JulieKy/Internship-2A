...
%     filtered_name=sprintf('%s\\..\\Data\\Filtered_Signals\\%d_filtered.wav', path, signal_n);
%     audiowrite(filtered_name, y_xsc, fn); % writing the filtered signal to an audio file    
